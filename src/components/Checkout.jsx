  ...
  return (
    ...
    <section className="bg-white md:rounded-3xl">
      <div className="flex justify-center">
        <p className="text-xl md:text-4xl font-extrabold pt-8 pb-10 block">รายละเอียดการจอง</p>
      </div>
      <div className="md:flex md:pb-6">
        ...
        <div className="md:w-[50%] md:px-10">
          ...
          <div className="rounded-3xl shadow-xl px-8 py-6 mx-6">
            ...
            <div>
              <button
                className="btn border-cyan-300 items-center w-full mt-2 bg-white hover:bg-white"
              >
                +เพิ่มผู้โดยสาร
              </button>
            </div>
          ...
          <div className="rounded-3xl shadow-xl px-8 py-6 mx-6">
            ...
            <div
              className="flex justify-between items-center text-red-600 font-semibold"
            >
