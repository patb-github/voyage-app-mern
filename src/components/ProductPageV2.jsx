...
import { faCartShopping, faLocationDot, faStar } from "@fortawesome/free-solid-svg-icons";
    ...
    <div>
      ...
      <div className="flex justify-between md:justify-center items-center py-4 px-12 md:gap-12">
        <div className="flex-col flex items-center gap-2">
          ...
          <p className="font-bold bg-gray-200 rounded-full p-2">{trip.start_date}</p>
        </div>
        <div className="flex-col flex items-center gap-2">
        ...
        <div className="flex-col flex items-center gap-2">
          ...
          <p className="font-bold bg-gray-200 rounded-full p-2">{trip.end_date}</p>
        </div>
      </div>
    </div>
  );
...
const ProductPageV2 = () => {
  ...
  const handleAddToCart = () => {
    if (user) {
      const updatedCart = [...user.cart, { ...trip, isChecked: false, total: trip.price }];
      ...
      <section className="bg-white md:rounded-3xl h-full">
        ...
        <div className="flex flex-col md:flex-row md:pb-8">
          ...
          <div className="md:flex md:flex-col md:h-auto md:w-[50%] md:px-16 md:border-r md:border-r-black">
            <ProductCarousel classes={"md:rounded-3xl fixed bottom-[50%] h-[50%] w-full object-cover md:relative md:h-[60%] md:bottom-auto"} trip={trip} />
          ...
          <div className="fixed top-[45%] h-[55%] w-full bg-white rounded-t-[2rem] flex flex-col justify-between overflow-y-auto
            ...
            <ProductDetails showDetail={showDetail} setShowDetail={setShowDetail} trip={trip} />
              ...
              <div className="flex justify-between md:justify-start p-4 text-base-content px-8 md:px-0">
                ...
                <div className="flex content-center gap-3 md:w-full md:justify-end">
                  <div className="flex gap-3">
                    <button className="btn btn-circle outline outline-1 outline-gray-300 bg-white" onClick={handleAddToCart}>
                      <FontAwesomeIcon icon={faCartShopping} className="fa-2x" style={{ color: "#000000" }} />
                    </button>
                    {showMedal && <div className="fixed bottom-20 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-4 py-2 rounded-full shadow-lg">
