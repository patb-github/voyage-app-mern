  ...
  <div className="h-full bg-cover bg-center bg-no-repeat bg-[url('../../assets/bg.svg')]">
    <div className="min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <h1 className="text-2xl text-center text-gray-800 font-semibold mb-6">Welcome</h1>
        ...
        <a href="#" className="text-sm text-blue-500 hover:text-blue-700 float-right mb-8 pt-4">Forgot Password?</a>
        <button className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
          Sign In
        </button>
        <p className="mt-8 text-sm text-center text-gray-600">
          Don’t have an account? <a href="#" className="text-blue-500 hover:text-blue-700">Create one</a>
        </p>
        ...
        <div className="flex justify-center gap-4 mt-4">
          ...
          <a href="#" className="text-gray-800"><i className="fab fa-apple"></i></a>
        </div>
      </div>
    </div>
  </div>
