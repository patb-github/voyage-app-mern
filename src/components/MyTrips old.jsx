  ...
  return (
    <section className="md:bg-gray-100 md:pb-80">
      ...
      >
        ...
        <a
          href="#"
          className="card w-96 h-80 mt-10 shadow-xl relative bg-white"
        >
          <figure>
            <img src="/destination/singapore.jpg" alt="singapore" />
            <div className="absolute top-2 left-2 text-white bg-black bg-opacity-30 p-2 rounded-full flex">
              <p>Bangkok</p>
          ...
          <div className="card-body flex-row h-24 px-4 py-4">
            <div className="mr-8 w-64">
              <h2 className="card-title text-[#5F97FB]">
                จำนวน Voyager
                <div className="badge badge-secondary rounded-full w-6 h-6 font-bold bg-[#5F97FB] text-xl border-0">
                  2
                </div>
              </h2>
              <h2 className="text-l font-bold">Booking ID : 123456</h2>
            </div>
            <div className="rounded-full w-16 h-16 border-solid border-[#5F97FB] border-2 font-bold flex flex-col items-center justify-center text-[#5F97FB]">
