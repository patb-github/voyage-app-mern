...
const EditBooking = () => {
  return (
    <section className="bg-white md:mx-[2%] md:my-24 md:rounded-3xl md:flex md:min-w-[90%]">
      <div className="hidden md:block">
        ...
        <p className="text-xl font-semibold py-4">
          Trip description ... Lorem ipsum dolor sit amet, consectetur
          adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
          magna aliqua. adipiscing elit, sed do eiusmod. Lorem ipsum dolor sit
